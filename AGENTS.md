...
```powershell
curl.exe "https://start.spring.io/starter.zip?type=maven-project&groupId=com.yonsai&artifactId=Day60_20260815&name=Day60_20260815&javaVersion=17&bootVersion=4.0.7&dependencies=web,devtools,thymeleaf" -o project.zip
